...
public class GameCourt extends JPanel {
    ...
    public void drawStrings(Graphics g, LinkedList<String> message, int x, int y, 
            int size, int spacing) {
	...
	public void paintComponent(Graphics g) {
        ...
        if (showInstruction) {
	        ...
	        g.drawString("Score: " + score, 400 - 
	                g.getFontMetrics().stringWidth("Score: " + score)/2, 120);
	        //draw strikes
	        g.setFont(new Font("Serif", Font.BOLD, 40));
	        g.drawString("Strikes: " + strikes, 400 - 
	                g.getFontMetrics().stringWidth("Strikes: " + strikes)/2, 180);
